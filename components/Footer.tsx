        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://github.com/Ogbeide456"
                target="_blank"
                rel="nner noreferrer"
                aria-label="GitHub"
              >
              ...
              <a href="https://www.linkedin.com/in/samuel-ogbeide-a99988284/"
                target="_blank"
              ...
              <a href="https://x.com/OgbeideSpezial"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="X"
              >
              ...
              <a href="https://www.instagram.com/ileri9806/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="footer-col">
            <h4>Get in Touch</h4>
            <a href="mailto:ileriunique40@gmail.com">
              ileriunique40@gmail.com
            </a>
